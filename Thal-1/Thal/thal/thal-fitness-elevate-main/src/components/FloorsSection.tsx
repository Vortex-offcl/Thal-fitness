...
const floors = [
  {
    ...
    features: ["Swimming Pool", "Reception", "Physio", "Shoe Rack"],
    icon: Heart,
    image: floorGround,
  },
  {
  ...
  },
  {
    id: "3",
    level: "Floor 3",
    title: "Leg & Lat Training",
    description: "Complete lower body and back workout stations for powerful gains.",
    features: ["Squat Racks", "Deadlift Platforms", "Leg Press", "Lat Pulldown"],
    icon: ActivitySquare,
    image: floorLegs,
  },
  {
    ...
    description: "Recovery rooms, therapy pools and studio spaces for mobility and light conditioning.",
    features: ["Recovery Rooms", "Therapy Pools", "Training Studios", "Mobility Zones"],
    icon: Dumbbell,
    image: floorFour,
  },
];
